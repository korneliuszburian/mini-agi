...
| `artifacts/` | run evidence | `artifacts/<case-name>/` — run reports, transcripts, progress from supervised runs (the convention: run evidence lives here, NEVER at the repo root) |
...
| `docs/EXPERIMENTS.md` | EXP-005..013: proof-of-advantage records | evidence for verified-iteration claims |
