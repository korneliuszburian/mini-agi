...
verify: sh -c "test -f .agents/skills/orchestrate/SKILL.md && grep -q 'SEAM' .agents/skills/orchestrate/SKILL.md && grep -q 'Completion criteria' .agents/skills/orchestrate/SKILL.md"
---
