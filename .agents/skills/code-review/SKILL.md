...
verify: sh -c "test -f .agents/skills/code-review/SKILL.md && grep -q 'SEAM' .agents/skills/code-review/SKILL.md && grep -q 'Completion criteria' .agents/skills/code-review/SKILL.md"
---
